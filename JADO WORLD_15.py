...
# CAPA 3: Etiquetas de referencia (Nombres y fronteras)
TileLayer(
...
for i, nombre_unidad in enumerate(unidades):
    ...
    Marker(
        ...
        tooltip=f"<b>Unidad:</b> {nombre_unidad}"
    ).add_to(m)
...
nombre_archivo = "JADO_WORLD_v15.html"
m.save(nombre_archivo)

print("-" * 40)
print(f"✅ ¡VERSIÓN CON NATIONAL GEOGRAPHIC GENERADA!")
